% Convert BROAD dataset as input =[imu_acc imu_gyro imu_mag]
clc
clear all

% Add BROAD dataset (data_mat) file path in below as 'filepath'
...
for i = 1:size(filepath)
    ...
    save (['input' num2str(i) '.mat'],'in_temp');
    save (['output' num2str(i) '.mat'],'out_temp');
